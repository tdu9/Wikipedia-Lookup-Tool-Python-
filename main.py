...
my_entry = Entry(my_label_frame, font=('MS Gothic', 18), width=47)
...
search_button = Button(button_frame, text='Look Up', font=('MS Gothic', 32), fg='#3a3a3a', command=search)
search_button.grid(row=0, column=0, padx=20)

clear_button = Button(button_frame, text='Clear', font=('MS Gothic', 32), fg='#3a3a3a', command=clear)
